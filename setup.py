...
records_resources_version = ">=0.17.2,<0.18"
...
extras_require = {
    ...
    'mysql': [
        f'invenio-records-resources[mysql]{records_resources_version}'
    ],
    'postgresql': [
        f'invenio-records-resources[postgresql]{records_resources_version}'
    ],
    'sqlite': [
        f'invenio-records-resources[sqlite]{records_resources_version}'
    ],
    'tests': tests_require,
}
...
setup(
    ...
    entry_points={
        ...
        'invenio_base.blueprints': [
            'invenio_requests = invenio_requests.views:blueprint',
        ],
        'invenio_db.models': [
            'request_model = invenio_requests.records.models',
        ],
